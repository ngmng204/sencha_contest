 ...
 */
Ext.define('Ext.data.ConnectionFixed', {
    mixins: {
    ...
    setOptions: function(options, scope) {
        ...
        /* Fix bug of sencha when method is post but it is automatically add a _dc=xxxxxxx into the url request  **/
        if(method == "POST" || method == "post"){
           var urlTemp = url.split("?");
           console.log(urlTemp);
           var originUrl = urlTemp[0];
           if(urlTemp.length > 1){
                url = originUrl;
           }
